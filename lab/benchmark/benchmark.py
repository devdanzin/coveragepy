...
class ProjectMashumaro(ProjectToTest):
    ...
    def prep_environment(self, env):
        ...
        # https://github.com/Fatal1ty/mashumaro/issues/227 :
        env.shell.run_command(f"{env.python} -m pip install -U typing_extensions==4.11.0")
    ...
    def load_results(self) -> dict[ResultKey, list[float]]:
        ...
        if self.results_file.exists():
            with self.results_file.open("r") as f:
                data: dict[ResultKey, list[float]] = json.load(f)
